"""Skill validation logic following the Agent Skills specification."""
...
def _validate_name(name: str, skill_dir: Optional[Path] = None) -> list[str]:
    ...
    Skill names support lowercase alphanumeric characters plus hyphens.
